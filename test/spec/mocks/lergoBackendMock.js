...
angular.module('lergoBackendMock', []).run(function($httpBackend){
    ...
    $httpBackend.whenGET('/backend/user/isAdmin').respond(200, '{}');
    $httpBackend.whenGET('/backend/public/lessons').respond(200, '{}');
    $httpBackend.whenGET('/backend/public/publicLessonsUsernames').respond(200, '{}');
    ...
    $httpBackend.whenGET('/backend/public/lessons?query=%7B%22filter%22:%7B%22public%22:%7B%22$exists%22:1%7D%7D,%22projection%22:%7B%22userId%22:1,%22_id%22:0%7D,%22limit%22:0%7D').respond(200, '[]');
