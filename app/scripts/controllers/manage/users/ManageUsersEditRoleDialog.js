(function () {
     ...
     */
    ManageUsersEditRoleDialogCtr.$index = ['$scope', '$uibModalInstance', 'LergoClient'];
    function ManageUsersEditRoleDialogCtr($scope, $uibModalInstance, LergoClient ) {
    ...
    angular.module('lergoApp')
        .controller('ManageUsersEditRoleDialogCtrl', ManageUsersEditRoleDialogCtr );
})();
