...
angular.module('lergoApp').controller('LessonsUpdateCtrl',function($scope, $log, LergoClient, $location, $routeParams, ContinuousSave, FilterService, $modal, QuestionsService) {
	...
	/**
	 * watch questions in step. iterates over all steps of type
	 * 'quiz' and turns the quizItems arrays to a single array *
	 */
	...
	$scope.openQuestionBank = function(step) {
		$modal.open({
			...
			backdrop : 'static',
			controller : [ '$scope', '$modalInstance', 'step', 'addItemToQuiz',
					function($scope, $modalInstance, step, addItemToQuiz) {
