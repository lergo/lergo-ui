(function () {
    'use strict';
    QuestionsReadCtrl.$inject = ['$scope', 'QuestionsService', '$routeParams', 'ContinuousSave', '$log', '$compile', 'LergoClient', '$sce', '$location', '$window', 'LergoTranslate'];
    function QuestionsReadCtrl($scope, QuestionsService, $routeParams, ContinuousSave, $log, $compile, LergoClient, $sce, $location, $window, LergoTranslate) {
    ...
    angular.module('lergoApp')
        .controller('QuestionsReadCtrl', QuestionsReadCtrl);
})();
