(function () {
	'use strict';
	QuestionsAddUpdateDialogCtrl.$inject = ['$scope', '$uibModalInstance', 'quizItem', 'lessonOverrideQuestion', 'QuestionsService', 'isUpdate', '$controller', 'step', 'addItemToQuiz', '$log', '$filter'];
	function QuestionsAddUpdateDialogCtrl($scope, $uibModalInstance, quizItem, lessonOverrideQuestion, QuestionsService, isUpdate, $controller, step, addItemToQuiz, $log, $filter) {
	...
	angular.module('lergoApp')
		.controller('QuestionsAddUpdateDialogCtrl',QuestionsAddUpdateDialogCtrl);
})();
