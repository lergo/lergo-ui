...
angular.module('lergoApp')
    .controller('CreateLessonCtrl', function ($scope) {
        ...
        $scope.lesson = { 'title': 'confusing words: they\'re,their,there', 'steps': [
            { 'name': 'quiz', 'type': QUIZ_TYPE, 'questions': []}
        ], 'language': 'English', 'subject': 'Math', 'languages': ['Espanol', 'English']};
        ...
        function _getStepsByType(type) {
            return $.grep($scope.lesson.steps, function (item/*, index*/) {
