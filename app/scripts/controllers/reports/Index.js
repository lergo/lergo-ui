(function () {
    'use strict';
    ReportsIndexCtrl.$inject = ['$scope', 'LergoClient', 'TagsService', '$routeParams', '$log', 'LergoTranslate', '$location', '$rootScope', 'localStorageService', '$window', '$filter'];
    function ReportsIndexCtrl($scope, LergoClient, TagsService, $routeParams, $log, LergoTranslate, $location, $rootScope,
    ...
    angular.module('lergoApp')
        .controller('ReportsIndexCtrl', ReportsIndexCtrl);
})();
