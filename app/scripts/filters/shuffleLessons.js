...
/**
 * @ngdoc filter
 * @name lergoApp.filter:shuffleLessons
 * @function
 * @description
 * # shuffleLessons <br/>
 * This filter handles lessons.<br/>
 * It adds on top of the {@link shuffle} filter and handles lessons with answers
 *
 */
angular.module('lergoApp')

    .filter('shuffleLessons', function ($filter, $log, ReportsService) {
         ...
         * @param {Report} opts.report the report with the lessons and answers
        ...
        return function (opts) {
            ...
            //sort lessons according to answer existence. this adds supports to continue lesson LERGO-583.
