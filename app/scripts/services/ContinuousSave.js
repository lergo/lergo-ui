...
angular.module('lergoApp')
    .factory('ContinuousSave', function (localStorageService, $timeout, $rootScope, $log) {
        ...
        function impl(opts) {
            ...
            var _saveFn = undefined;  // a function that returns a promise and saves the model.
            ...
            this.versionMatch = _versionMatch;
            this.save = _save;
