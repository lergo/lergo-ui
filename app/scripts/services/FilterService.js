...
angular.module('lergoApp').service('FilterService', function Filterservice($rootScope) {
	...
	this.subjects = [ 'english', 'math', 'geometry', 'science', 'language', 'grammar', 'spelling', 'biology', 'chemistry', 'physics', 'history', 'geography', 'art', 'music', 'financialEducation','roadSafety', 'other' ];
