...
angular.module('lergoApp').service('LergoClient', function LergoClient($http, $log, UsersService, QuestionsService, LessonsService, LessonsInvitationsService, UserDataService ) {
