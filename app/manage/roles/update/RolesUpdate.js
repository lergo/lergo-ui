(function(){
     ...
     */
    RolesUpdateCtrl.$inject = ['$scope', 'LergoClient', '$routeParams', '$log', '$location', '$q', 'LergoFilterService', 'LergoTranslate'];
    function RolesUpdateCtrl($scope, LergoClient, $routeParams, $log, $location, $q, LergoFilterService, LergoTranslate ) {
    ...
    angular.module('lergoApp')
        .controller('RolesUpdateCtrl', RolesUpdateCtrl );
    })();        
