(function(){
     ...
     */
    ManageUsersUpdateCtr.$index = ['$scope', '$routeParams', 'LergoClient', '$uibModal', '$location'];
    function ManageUsersUpdateCtr($scope, $routeParams, LergoClient, $uibModal, $location ) {
    ...
    angular.module('lergoApp')
        .controller('ManageUsersUpdateCtrl', ManageUsersUpdateCtr );
})();
