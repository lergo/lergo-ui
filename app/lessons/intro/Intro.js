(function(){
    'use strict';
    LessonsIntroCtrl.$inject = ['$scope', '$routeParams', 'LergoClient', '$location', '$uibModal', 'DisplayRoleService', '$log', '$rootScope', 'LergoTranslate', '$window', '$filter']
    function LessonsIntroCtrl($scope, $routeParams, LergoClient, $location, $uibModal, DisplayRoleService, $log, $rootScope, LergoTranslate, $window, $filter) {
        $window.scrollTo(0, 0);
    ...
    .controller('LessonsIntroCtrl',LessonsIntroCtrl);
