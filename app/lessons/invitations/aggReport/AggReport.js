(function(){
    'use strict';
    LessonsInvitationsAggReportCtrl.$inject = ['$window', '$scope', '$log', 'LergoClient', '$routeParams', 'LergoTranslate', '$location', '$filter', '$rootScope'];
    function LessonsInvitationsAggReportCtrl($window, $scope, $log, LergoClient, $routeParams, LergoTranslate, $location, $filter, $rootScope) {
            $log.info('loading');
    ...
    .controller('LessonsInvitationsAggReportCtrl', LessonsInvitationsAggReportCtrl);
