(function(){
    'use strict';
    LessonsInvitationsReportCtrl.$inject = ['$scope', '$log', 'LergoClient', '$routeParams', 'LergoTranslate', '$location', '$filter', '$rootScope'];
    function LessonsInvitationsReportCtrl($scope, $log, LergoClient, $routeParams, LergoTranslate, $location, $filter, $rootScope) {
        $log.info('loading');
    ...
    angular.module('lergoApp')
        .controller('LessonsInvitationsReportCtrl',LessonsInvitationsReportCtrl);
})();
