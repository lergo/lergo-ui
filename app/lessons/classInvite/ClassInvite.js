(function(){
    'use strict';
    ClassInviteCtrl.$inject = ['$window', '$scope', 'LergoClient', '$routeParams', '$log', 'LergoTranslate', '$rootScope' , '$location']
    function ClassInviteCtrl($window, $scope, LergoClient, $routeParams, $log, LergoTranslate, $rootScope , $location ) {
        $window.scrollTo(0, 0);
    ...
    angular.module('lergoApp')
        .controller('ClassInviteCtrl', ClassInviteCtrl);
})();        
