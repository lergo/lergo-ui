(function(){
    'use strict';
    LessonsUpdateCtrl.$inject = ['$scope', '$log', 'LergoClient', '$location', '$routeParams', 'ContinuousSave', 'LergoFilterService', '$uibModal', 'TagsService', 'QuestionsService', '$rootScope', '$window', '$filter', 'LergoTranslate', '$translate'];
    function LessonsUpdateCtrl($scope, $log, LergoClient, $location, $routeParams, ContinuousSave, LergoFilterService, $uibModal, TagsService, QuestionsService, $rootScope, $window, $filter, LergoTranslate, $translate) {
        $window.scrollTo(0, 0);
    ...
    angular.module('lergoApp').
        controller('LessonsUpdateCtrl',LessonsUpdateCtrl);
    })();
