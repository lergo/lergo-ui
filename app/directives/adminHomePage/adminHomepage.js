(function () {
     ...
     * # adminHomepage
     */
    adminHomepage.$inject = ['$controller', '$routeParams', '$location', '$route', '$log'];
    function adminHomepage($controller, $routeParams, $location, $route, $log  ) {
        return {
            templateUrl: 'directivesadminHomePage/homepage.html',
            restrict: 'A',
            transclude: true,
            link: function ($scope) {
    ...
    angular.module('lergoApp')
        .directive('adminHomepage', adminHomepage);
})();
