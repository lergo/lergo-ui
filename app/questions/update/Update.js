(function(){
    'use strict';
    QuestionsUpdateCtrl.$inject = ['$scope', 'QuestionsService', 'LergoClient', '$routeParams', 'ContinuousSave', '$log', '$location', 'LergoFilterService', 'TagsService', '$window', '$filter'];
    function QuestionsUpdateCtrl($scope, QuestionsService, LergoClient, $routeParams, ContinuousSave, $log, $location, LergoFilterService, TagsService, $window, $filter) {
        $window.scrollTo(0, 0);
    ...
    angular.module('lergoApp').controller('QuestionsUpdateCtrl', QuestionsUpdateCtrl);
})();
